                      ...
                      <form role="form" method="POST" action="{{ route('admin.store.contact') }}">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="phone" placeholder="Enter Your phone">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Mobile</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="mobile" placeholder="Enter Your mobile">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputPassword1" name="facebook_url" placeholder="Enter Your Facebook_URL">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Twitter_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="twitter_url" placeholder="Enter Your Twitter_url">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Instagram_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="instagram_url" placeholder="Enter Your Instagram_url">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Linkedin_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="linkedin_url" placeholder="Enter Your Linkedind_url">
                          </div>
