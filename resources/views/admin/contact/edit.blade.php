...
<html>
  <head>
    ...
    <link href="{{ asset('front/css/edit.css') }}" rel="stylesheet" type="text/css" />
                      ...
                      <form role="form" method="POST" action="{{ route('admin.update.contact',$contactData->id) }}">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="phone" value="{{ $contactData->phone }}" placeholder="Enter Your Phone">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Mobile</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="mobile" value="{{ $contactData->mobile }}" placeholder="Enter Your Mobile">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Email</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="email" value="{{ $contactData->email }}" placeholder="Enter Your Email">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Facebook_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="facebook_url" value="{{ $contactData->facebook_url }}" placeholder="Enter Your Facebook_URL">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Twitter_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="twitter_url" value="{{ $contactData->twitter_url }}" placeholder="Enter Your Twitter_URL">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Instagram_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="instagram_url" value="{{ $contactData->instagram_url }}" placeholder="Enter Your Instagram_URL">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Linkedin_URL</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="linkedin_url" value="{{ $contactData->linkedin_url }}" placeholder="Enter Your Linkedin_URL">
                          </div>
                          {{-- <div class="form-group">
