                      ...
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $ct->mobile }}</td>
                                <td>{{ $ct->email }}</td>
                                <td>{{ $ct->facebook_url }}</td>
                                <td>{{ $ct->twitter_url }}</td>
                                <td>{{ $ct->instagram_url }}</td>
                                <td>{{ $ct->linkedin_url }}</td>
                                <td>
                                    <a href="{{ route('admin.edit.contact',$ct->id) }}" class="btn btn-primary">Edit</a>

                                    <a href="{{ route('admin.delete.contact',$ct->id) }}" class="btn btn-danger">Delete</a>
                                </td>
