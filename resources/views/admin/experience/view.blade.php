                      ...
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $ex->title }}</td>
                                <td>{{ $ex->sub_title }}</td>
                                <td>{{ $ex->second_title }}</td>
                                <td>{{ $ex->description }}</td>
                                <td>
                                    <a href="{{ route('admin.edit.experience',$ex->id) }}" class="btn btn-primary">Edit</a>

                                    <a href="{{ route('admin.delete.experience',$ex->id) }}" class="btn btn-danger">Delete</a>
                                </td>
