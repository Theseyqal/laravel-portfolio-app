                      ...
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{-- <img src="{{ $ab->about_image }}" width="150" height="150"  alt=""> --}}
                                    <img src="{{ asset($ab->about_image) }}" width="100" height="100" alt="">

                                </td>
                                <td>
                                    <a href="{{ route('admin.edit.about',$ab->id) }}" class="btn btn-primary">Edit</a>

                                    <a href="{{ route('admin.delete.about',$ab->id) }}" class="btn btn-danger">Delete</a>
                                </td>
