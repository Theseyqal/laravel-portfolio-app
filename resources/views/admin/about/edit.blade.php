                      ...
                      <form role="form" method="POST" action="{{ route('admin.update.about',$aboutData->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="about_details" value="{{ $aboutData->about_details }}" placeholder="Enter About">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">About image </label>
                            <input type="file" class="form-control" id="exampleInputPassword1" name="about_image" value="{{ $aboutData->about_image }}" >
                          </div>
                            ...
                            <style>
                                ...
                                <img src="{{ asset($aboutData->about_image) }}" width="150" class="img-fancy" alt="About Image">
