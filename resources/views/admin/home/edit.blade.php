                      ...
                      <form role="form" method="POST" action="{{ route('admin.update.home',$homeData->id) }}">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="name" value="{{ $homeData->name }}" placeholder="Enter Your Name">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Profession</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="profession" value="{{ $homeData->profession }}" placeholder="Enter Your Profession">
                          </div>
                          {{-- <div class="form-group">
