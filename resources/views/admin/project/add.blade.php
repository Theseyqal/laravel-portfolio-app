                      ...
                      <form role="form" method="POST" action="{{ route('admin.store.project') }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                          {{-- <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="class" placeholder="Enter Your Class">
                          </div> --}}
                          <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="title" placeholder="Enter Your Title">
                          </div>
                           <div class="form-group">
                            <label for="exampleInputEmail1">Sub Title</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="sub_title" placeholder="Enter Your Sub_Title">
                          </div>
                          {{-- <div class="form-group">
