                      ...
                      <form role="form" method="POST" action="{{ route('admin.update.project',$projectData->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="class" value="{{ $projectData->class }}" placeholder="Enter About">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Image </label>
                            <input type="file" class="form-control" id="exampleInputPassword1" name="image" value="{{ $projectData->image }}" >
                          </div>
                            ...
                            <style>
                                ...
                                .img-fancy:hover {
                                    box-shadow: 0 0 20px 7px rgba(0, 123, 255, 0.7);
                                ...
                                <img src="{{ asset($projectData->image) }}" width="150" class="img-fancy" alt="About Image">

                                <div class="form-group">
                            <label for="exampleInputEmail1">Title</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="title" value="{{ $projectData->title }}" placeholder="Enter your title">
                          </div>
                          <div class="form-group">
