                      ...
                      <form role="form" method="POST" action="{{ route('admin.store.experience') }}">
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="timeline" placeholder="Enter Your Timeline">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Title</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="title" placeholder="Enter Your title">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputEmail1">Sub title</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="sub_title" placeholder="Enter Your subtitle">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Second title</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="second_title" placeholder="Enter Your second title">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Description</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="description" placeholder="Enter Your Description">
                          </div>
                          {{-- <div class="form-group">
