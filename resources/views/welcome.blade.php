        ...
        <div class="container">
            <div class="disply-table">
                <div class="table-cell" data-aos="fade-up" data-aos-delay="0">
                    ...
                    @php
                        $homeData = DB::table('homes')->get();
                    @endphp

                    @foreach ($homeData as $home )
                        <h4>{{ $home->name }}</h4>
                        <h1>{{ $home->profession }}</h1>
                    @endforeach
                    </div>
            </div>
        </div>
    ...
    <div class="section" id="about">
        ...
        <div class="container">
            ...
            <div class="col-md-6" data-aos="fade-up">
                ...
                <div class="h-50"></div> <img src={{ asset('front/img/Signature.svg') }} width="230" alt="" />
                <div class="h-50"></div>
            </div>
            <div class="col-md-6 about-img-div">
                <div class="about-border" data-aos="fade-up" data-aos-delay=".5"></div>
                <img src="{{ asset($about->about_image )}}" width="400" class="img-responsive" alt="" align="right" data-aos="fade-right" data-aos-delay="0" />
            </div>
        </div>
        @endforeach
    </div>
                    ...
                    <div class="portfolio">
                        ...
                        <div class="no-padding portfolio_container clearfix" data-aos="fade-up">
                            ...
                            <div class="col-md-4 col-sm-6  {{ $project->class }} ">
                                <a id="demo01" href="#animatedModal" class="portfolio_item"> <img src="{{ asset($project->image) }}" alt="image" width="1000" height="1000" class="img-responsive" />
            ...
            <div class="col-md-4" data-aos="fade-up">
             ...
             @endphp
                ...
                <ul class="social">
                    ...
                    <li><a href="{{ $contact->linkedin_url }}"><i class="ion-social-linkedin"></i></a></li>
                </ul>
                @endforeach
                ...
                <form class="contact-bg" name="contact" method="post" action="{{ route('admin.store.contact.form') }}" novalidate="novalidate">
                    ...
                    <!-- پیام موفقیت -->
                        @if(session()->has('success'))
                            <div id="success" style="color: green; margin-top: 20px;">
                                <p>{{ session('success') }}</p>
                            </div>
                        @endif
